...
Flight::route('GET /final/login', function(){
    ...
    */
    ...
    $user = $service->login($payload['email']);
    ...
    $jwt_payload = [
        'user' => $user,
        'iat' => time(),
        'exp' => time() + (86000) // token valid for 86000 seconds
    ];
    ...
    Flight::json(["message" => "Logged in successfully", "token" => $token]);
});
...
Flight::route('GET /final/share_class_categories', function(){
    ...
    */
    ...
    $service = new FinalService();
    $data = $service->share_class_categories();
